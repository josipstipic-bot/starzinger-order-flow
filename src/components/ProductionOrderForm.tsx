        ...
        <div className="text-center mb-8">
          <div className="bg-gradient-primary text-primary-foreground py-6 px-8 rounded-lg shadow-medium mb-6">
            <div className="flex items-center justify-center gap-4 mb-4">
              <img src="/lovable-uploads/30f5d91d-b692-4ad3-85ff-f9b9b45f5bf2.png" alt="Starzinger Logo" className="h-16 w-auto filter invert brightness-0 invert" />
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card className="shadow-soft">
            ...
            <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div>
                <Label htmlFor="decorationNumber" className="text-sm font-medium">can cliche number</Label>
