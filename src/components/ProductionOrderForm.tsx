        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card className="shadow-soft">
            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="recipeOther" className="text-sm font-medium">CO2 content in g/L (+/- 0,1) </Label>
          ...
          <Card className="shadow-soft">
           ...
           <Card className="shadow-soft">
             <CardHeader className="bg-gradient-to-r from-accent/5 to-primary/5">
               <CardTitle className="text-primary flex items-center gap-2">
                 <span className="w-8 h-8 bg-accent text-accent-foreground rounded-full flex items-center justify-center text-sm font-bold">9</span>
                 Additional Information
               </CardTitle>
             </CardHeader>
             <CardContent className="pt-6">
